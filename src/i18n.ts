...
export const MESSAGES: Record<string, Record<string, string>> = {
  en: {
    ...
    "terminal.closeRunningConfirm": "“{name}” is still running in this terminal. Close it anyway?",
  ...
  ko: {
    ...
    "terminal.closeRunningConfirm": "이 터미널에서 “{name}” 이(가) 실행 중입니다. 그래도 닫을까요?",
