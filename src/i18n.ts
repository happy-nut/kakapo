...
export const MESSAGES: Record<string, Record<string, string>> = {
  en: {
    ...
    "settings.persistTerminal": "Keep terminal sessions running when kakapo quits (tmux)",
    "settings.persistTerminal.hint": "Applies to terminals you open from now on. Closing a pane still ends its session.",
    "settings.installTmux": "Install tmux",
    "settings.tmuxReady": "tmux is installed — new terminals will survive a restart.",
    "settings.tmuxMissing": "tmux is not installed. Terminals stay in kakapo until it is.",
  ...
  ko: {
    ...
    "settings.persistTerminal": "kakapo를 종료해도 터미널 세션 유지 (tmux)",
    "settings.persistTerminal.hint": "지금부터 여는 터미널에 적용됩니다. 패널을 닫으면 그 세션은 종료됩니다.",
    "settings.installTmux": "tmux 설치",
    "settings.tmuxReady": "tmux가 설치돼 있습니다 — 새로 여는 터미널은 재시작해도 살아남습니다.",
    "settings.tmuxMissing": "tmux가 설치돼 있지 않습니다. 설치 전까지 터미널은 kakapo와 함께 종료됩니다.",
