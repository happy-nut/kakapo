...
**독자의 말로 쓰세요.** 이 저장소의 리뷰어가 지금까지 **직접 써 온 단어**가 다음 파일에 한 줄에 하나씩 있습니다:
{{TERMS_PATH}}

읽기만 하세요 — 이 파일에는 절대 쓰지 마세요. 단어가 거기 오르는 것은 독자가 그 말을 직접 썼을 때뿐이고, 당신이 고른 이름이 아니라 독자가 고른 이름이라는 것이 저 파일의 존재 이유입니다. 대신 설명을 쓸 때 세 가지를 지키세요.
...
그 파일이 없거나 비어 있으면 아직 리뷰어가 쓴 말이 쌓이지 않은 것입니다. 그때는 더더욱 새 이름을 만들지 말고, 누구나 아는 쉬운 말로 쓰세요 — 이번 설명에서 리뷰어가 처음 만나는 말이 곧 다음번 그 사람의 단어가 됩니다.
