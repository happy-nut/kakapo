...
export function renderDiffHtml(input: {
  ...
  return [
    ...
    '<aside class="settings-nav"><div class="settings-nav-title">Settings</div><button type="button" class="settings-cat active" data-cat="general">General</button><button type="button" class="settings-cat" data-cat="prompts">Merge prompts</button></aside>',
    ...
    '<div id="app-info-status" class="app-info-status">Checking for updates…</div>',
    '<button type="button" id="app-info-update" class="plain-button app-info-update hidden">Update &amp; Restart</button>',
    '<div class="app-info-keys"><div class="app-info-keys-h">Keyboard shortcuts</div><div class="keys-grid"><kbd>F7</kbd><span>Next change</span><kbd>Shift+F7</kbd><span>Previous change</span><kbd>Cmd/Ctrl+W</kbd><span>Close tab</span><kbd>Cmd/Ctrl+Shift+[ / ]</kbd><span>Prev / next tab</span><kbd>Cmd/Ctrl+[ / ]</kbd><span>Cursor back / forward</span><kbd>Shift Shift</kbd><span>Find file</span><kbd>Cmd/Ctrl+Shift+F</kbd><span>Find in files</span><kbd>Cmd/Ctrl+E</kbd><span>Recent files</span><kbd>Cmd/Ctrl+B</kbd><span>Definition / usages</span><kbd>Cmd/Ctrl+&darr;</kbd><span>Go to definition</span><kbd>Cmd/Ctrl+1 / 0</kbd><span>Files / Changes tab</span><kbd>Tab</kbd><span>Sidebar &harr; content</span><kbd>Opt/Alt+&larr;/&rarr;</kbd><span>Word jump (vim w)</span><kbd>Cmd/Ctrl+&larr;/&rarr;</kbd><span>Line start / end</span><kbd>Shift+arrows</kbd><span>Extend selection</span><kbd>&lt;</kbd><span>Toggle viewed</span><kbd>? &nbsp;&gt;</kbd><span>Add question / change</span><kbd>Cmd/Ctrl+Shift+/ .</kbd><span>All questions / changes</span><kbd>Cmd/Ctrl+Shift+W</kbd><span>Ignore whitespace</span><kbd>Cmd/Ctrl+Enter</kbd><span>Save comment</span></div></div>',
    "</section>",
    '<section class="settings-section hidden" data-cat="prompts">',
    '<div class="settings-h">Merge prompts</div>',
    '<div class="settings-desc">Heading prepended to the merged prompt opened with Cmd/Ctrl+Shift+/ (questions) and Cmd/Ctrl+Shift+. (change requests). Leave blank to use the default.</div>',
    '<label class="settings-label" for="settings-prompt-q">Questions heading</label>',
    '<textarea id="settings-prompt-q" class="settings-textarea" rows="4" spellcheck="false"></textarea>',
    '<label class="settings-label" for="settings-prompt-c">Change-requests heading</label>',
    '<textarea id="settings-prompt-c" class="settings-textarea" rows="4" spellcheck="false"></textarea>',
    '<div class="settings-actions"><button type="button" id="settings-reset" class="plain-button">Reset to defaults</button><span id="settings-saved" class="settings-saved"></span></div>',
    "</section>",
    "</div>",
    "</div>",
    "</div>",
